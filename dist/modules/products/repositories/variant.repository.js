...
let VariantRepository = VariantRepository_1 = class VariantRepository extends abstract_repository_1.AbstractRepository {
    constructor(variantRepository) {
        super(variantRepository);
        this.variantRepository = variantRepository;
        this.logger = new common_1.Logger(VariantRepository_1.name);
    }
};
exports.VariantRepository = VariantRepository;
exports.VariantRepository = VariantRepository = VariantRepository_1 = __decorate([
