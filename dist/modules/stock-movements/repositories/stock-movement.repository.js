...
let StockMovementRepository = StockMovementRepository_1 = class StockMovementRepository extends abstract_repository_1.AbstractRepository {
    constructor(stockMovementRepository) {
        super(stockMovementRepository);
        this.stockMovementRepository = stockMovementRepository;
        this.logger = new common_1.Logger(StockMovementRepository_1.name);
    }
};
exports.StockMovementRepository = StockMovementRepository;
exports.StockMovementRepository = StockMovementRepository = StockMovementRepository_1 = __decorate([
